...
package net.svisvi.jigseugorka.entity;

import net.svisvi.jigseugorka.procedures.VacuumCleanerWhileProjectileFlyingTickProcedure;
import net.svisvi.jigseugorka.init.JigseuGorkaModItems;
import net.svisvi.jigseugorka.init.JigseuGorkaModEntities;
...
public class VacuumCleanerEntity extends AbstractArrow implements ItemSupplier {
	public VacuumCleanerEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(JigseuGorkaModEntities.VACUUM_CLEANER.get(), world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(JigseuGorkaModItems.DRILL_FUEL.get());
	}
	...
	public static VacuumCleanerEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		VacuumCleanerEntity entityarrow = new VacuumCleanerEntity(JigseuGorkaModEntities.VACUUM_CLEANER.get(), entity, world);
	...
	public static VacuumCleanerEntity shoot(LivingEntity entity, LivingEntity target) {
		VacuumCleanerEntity entityarrow = new VacuumCleanerEntity(JigseuGorkaModEntities.VACUUM_CLEANER.get(), entity, entity.level);
